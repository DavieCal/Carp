...
boxplot(Delta$LFCCR,  ylab = "Carp Frequency")
dotchart(Delta$LFCCR, xlab = "Carp Frequency",
...
Z <- cbind(Delta$LFCCR, Delta$DF, Delta$Discharge_cms, Delta$Pelicans,Delta$Logger_Temp_C, 
           Delta$Percent_Obstructed, Delta$Exposure, Delta$Image_Clarity, 
           Delta$Water_Clarity)

colnames(Z) <- c("Count","Dead", "Discharge", "Pelicans",
                 "Temp", "Obstructed", "Exposure", "ImageClarity","WaterClarity" )
...
corvif(Z[,c("Discharge","Temp","Daylength")])      #Part of Table 1
